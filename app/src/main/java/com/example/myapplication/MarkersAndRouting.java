 ...
 */
public class MarkersAndRouting extends AppCompatActivity implements OnMapReadyCallback, MapboxMap.OnMapClickListener, PermissionsListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.markers_routing);
    ...
    public void onMapReady(@NonNull final MapboxMap mapboxMap) {
        ...
        mapboxMap.setStyle(Style.OUTDOORS, new Style.OnStyleLoaded() {
            ...
            public void onStyleLoaded(@NonNull Style style) {
                ...
                new LoadGeoJsonDataTask(MarkersAndRouting.this).execute();

                mapboxMap.addOnMapClickListener(MarkersAndRouting.this);
...
// Call this method with Context from within an Activity
                        NavigationLauncher.startNavigation(MarkersAndRouting.this, options);
                    }
                });
            }
        });
...
// calling addImages is faster as separate addImage calls for each bitmap.
    ...
    private static class LoadGeoJsonDataTask extends AsyncTask<Void, Void, FeatureCollection> {
        ...
        private final WeakReference<MarkersAndRouting> activityRef;

        LoadGeoJsonDataTask(MarkersAndRouting activity) {
            this.activityRef = new WeakReference<>(activity);
        }

        @Override
        protected FeatureCollection doInBackground(Void... params) {
            MarkersAndRouting activity = activityRef.get();
...
// Load GeoJSON file from local asset folder
    ...
    private static class GenerateViewIconTask extends AsyncTask<FeatureCollection, Void, HashMap<String, Bitmap>> {
        ...
        GenerateViewIconTask(MarkersAndRouting activity, boolean refreshSource) {
            this.activityRef = new WeakReference<>(activity);
            this.refreshSource = refreshSource;
        }

        GenerateViewIconTask(MarkersAndRouting activity) {
            this(activity, false);
        }
